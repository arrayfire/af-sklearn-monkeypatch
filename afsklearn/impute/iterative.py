...
from .._validation import _safe_indexing, check_array, check_is_fitted, check_random_state, is_scalar_nan
from ..preprocessing._data import normalize
from .base import _afBaseImputer, _check_inputs_dtype
from .simple import SimpleImputer


class IterativeImputer(_afBaseImputer):
    ...
    def fit_transform(self, X, y=None):
        ...
        if self.estimator is None:
            from ..linear_model.bayes import BayesianRidge
