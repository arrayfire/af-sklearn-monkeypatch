...
from ._validation import (
    _assert_all_finite, _num_samples, check_array, check_consistent_length, check_is_fitted, check_X_y, column_or_1d)
...
'variance_weighted'] or None or array-like of shape (n_outputs)
    ...
    # dtype=np.float64)
    denominator = af.sum(
        (weight * (y_true - af.tile(af.mean(y_true, weights=sample_weight, dim=0), y_true.shape[0])) ** 2), dim=0)
