...
def typemap(dtype):
    try:
        ...
        TypeMap = {numpy.dtype('float32'): arrayfire.f16.value,
                   ...
                   numpy.dtype('uint16'): arrayfire.u16.value,
        ...
        TypeMap = {numpy.dtype('float16'): arrayfire.Dtype.f16,
                   ...
                   numpy.dtype('uint16'): arrayfire.Dtype.u16,
