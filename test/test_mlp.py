...
from afsklearn.patcher import Patcher, _load_instance, _load_module
...
def sklearn_example() -> None:
    clf = sklearn.neural_network.MLPClassifier(random_state=1, max_iter=1000).fit(X_train, y_train)
